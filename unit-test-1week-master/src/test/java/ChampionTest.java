...
public class ChampionTest {
    ...
    public void testForRelatedString() {
        ...
        assertThat(sampleString1, anyOf(nullValue(), notNullValue()));
        assertThat(sampleString2, containsString("po"));
    ...
    public void shouldHaveSamePropertyAndValue() {
        ...
        List<String> champs = championNames1;
        assertThat(championNames1,samePropertyValuesAs(championNames2));
        assertThat(championNames1,samePropertyValuesAs(champs));
    }
